...
from ingestion_pipeline.sources.github_modelscope import (  # noqa: E402
    GitHubModelScopePipeline,
)
...
async def _run() -> None:
    ...
    target_raw = os.environ.get("GITHUB_TARGET_COUNT")
    target_count = None
    if target_raw:
        try:
            v = int(target_raw)
    ...
    pipeline = GitHubModelScopePipeline(timeout=60.0, target_repo_count=target_count)
